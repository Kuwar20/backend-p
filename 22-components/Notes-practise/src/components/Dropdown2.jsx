...
const Dropdown2 = () => {
    ...
    }, [dropdownRef]) // With useRef
    // }, [dropdownElement]) // With useState

    return (
        <div
            ref={dropdownRef} // With useRef
            // ref={e => setDropdownElement(e)} // With useState
            ...
            <div className='border rounded-md p-2'>
                <div className='flex items-center'>
                    ...
                    <div className='flex flex-wrap flex-grow'>
                        ...
                        <input
                            type="text"
                            ref={inputRef} // With useRef
                            // ref={el => setInputElement(el)} // With useState
                            value={searchTerm}
