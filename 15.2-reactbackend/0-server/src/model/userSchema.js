import pool from '../utils/connDBmySQL.js';
        ...
        connection.query(`CREATE DATABASE IF NOT EXISTS ${dbName}`, (err) => {
            ...
            connection.query(`USE ${dbName}`, (err) => {
                ...
                connection.query(createTableQuery, (err) => {
                    ...
                    // const insertQuery = `INSERT INTO ${tableName} (username, email) VALUES ('kuwar','kuwar@gmail.com')`;
                    ...
                    // const updateQuery = `UPDATE ${tableName} SET username='kuwarx'`;
                    ...
                    // delete
                    // const deleteQuery = `DELETE FROM ${tableName} WHERE username='kuwarx'`;
